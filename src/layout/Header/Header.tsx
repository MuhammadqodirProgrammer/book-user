...
function Header() {
  ...
  return (
    <>
      <header className=" header text-[black] dark:text-[white] bg-[#EDF2F7] dark:bg-[#171923]  fixed w-full z-50 top-0 left-0 flex items-center">
        <div className="flex  px-[5px]  sm:px-0  gap-x-5 m-auto  justify-between container items-center">
          <Link
            href="/"
          ...
          <div className="chakra-stack flex md:gap-x-2  gap-x-3 ">
            <button
              type="button"
            ...
            {userName ? (
              <div className="relative">
                <button
                  className=" flex items-center gap-x-2 font-semibold justify-center h-[45px] w-[45px] rounded-full  bg-white dark:bg-[#2D3748] "
                  onClick={() => {
                    if (logoutRef?.current?.classList.contains("hidden")) {
                      logoutRef?.current?.classList.remove("hidden");
                      logoutRef?.current?.classList.add("block");
                    } else {
                      logoutRef?.current?.classList.remove("block");
                ...
                <button
                  ref={logoutRef}
                  className="absolute top-11 hidden right-0 bg-[#2d3748] p-2 w-[100px]"
                  onClick={() => {
              ...
              <Link href="/auth/login" className="block auth_button">
                <button
                  type="button"
                  className="chakra-button flex items-center gap-x-2 font-semibold"
                >
                  Kirish
                  <span className="m-0">
                    <svg
      ...
      {isOffcanvasOpen && (
        <nav className="navbar_offcanvas bg-[#EDF2F7]  dark:bg-[#475569]  fixed top-0 left-0  h-screen  ">
          ...
          <div className=" bg-[#EDF2F7]  dark:bg-[#475569] h-screen ">
            <div className="navbar_box  mt-0">
                ...
                <button
                  ...
                  className={
                    pathname == "/"
                      ...
                      : "nav_link-button text-sideBar dark:text-[#D0BCFA]"
                  }
                >
                  <div className="flex items-center gap-x-2 justify-start">
                    ...
                    <p className="chakra-text css-0">Bosh sahifa</p>
                  </div>
                </button>
              </Link>
              <Link className="nav_link" href="/courses">
                <button
                  type="button"
                  data-active
                  className={
                ...
                >
                  <div className="flex items-center gap-x-2 justify-start">
                    ...
                    <p className="chakra-text css-0">Kurslar</p>
                  </div>
                </button>
              </Link>
              <Link className="nav_link" href="/resources">
                <button
                  type="button"
                  className={
                    pathname == "/resources"
                ...
                >
                  <div className="flex items-center gap-x-2 justify-start">
                    ...
                    <p className="chakra-text css-0">Kod manbalar</p>
                  </div>
                </button>
              </Link>
              <Link className="nav_link" href="/contact">
                ...
                >
                  <div className="flex items-center gap-x-2 justify-start">
                    ...
                    <p className="chakra-text css-0">Bog&apos;lanish</p>
                  </div>
                </button>
              </Link>
              <Link className="nav_link" href="/faq">
                <button
                  type="button"
                  className={
                    pathname == "/faq"
                ...
                >
                  <div className="flex items-center gap-x-2 justify-start">
                    ...
                    <p className="chakra-text css-0">FAQ</p>
                  </div>
                </button>
              </Link>
            </div>
